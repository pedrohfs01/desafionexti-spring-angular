package com.pedrofernandes.desafionexti.repository;

import com.pedrofernandes.desafionexti.domain.Pedido;
...
public interface PedidoRepository extends JpaRepository<Pedido, Long> {
    ...
    @Query("select distinct pedido from Pedido pedido left join fetch pedido.produtos")
